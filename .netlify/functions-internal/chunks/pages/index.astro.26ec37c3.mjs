/* empty css                           */import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, d as renderHead, e as renderSlot, m as maybeRenderHead, f as renderComponent } from '../astro.f8e4dcaa.mjs';
import 'html-escaper';
import 'cookie';
import 'kleur/colors';
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" class="bg-blue-100">
	<head>
		<meta charset="UTF-8">
...
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Navbar;
  return renderTemplate`${maybeRenderHead($$result)}<nav class="flex justify-between items-center bg-blue-800 p-2">
    <a class="block p-4 bg-black text-white" href="./">MNLADENA</a>
    <ul class="flex gap-4">
        <li>
        ...
        <li>
            <a class="block text-white" href="#about">Contact</a>
        </li>
    </ul>
</nav>`;
}, "D:/Works/Projects/myporto/porto/src/components/Navbar.astro");
...
}, "D:/Works/Projects/myporto/porto/src/components/Header.astro");
